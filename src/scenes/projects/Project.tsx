...
const Skill = ({ projectHeader, projectSubHeader, projectDescription, projectImage }: Props) => {
  const projectStyles = "my-16 mx-auto bg-primary-300 p-10 rounded-2xl w-5/6 md:w-[100%] md:my-0";
